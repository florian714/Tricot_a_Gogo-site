...
document.getElementById('persoForm').addEventListener('submit', function (e) {
    e.preventDefault();

    const name = document.getElementById('idName').value;
    const color = document.getElementById('idColor').value;
    const price = document.getElementById('idPrice').value;
    const option = document.getElementById('idOption').value;
    ...
    fetch(apiURL+'/produits/personnalise', {
        method: 'POST',
        headers: {
